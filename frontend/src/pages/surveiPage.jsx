...
export default function SurveiPage() {
    ...
    return (
        <div className="mt-13 md:mt-25 p-10 grid grid-cols-1 md:grid-cols-2 gap-10 place-items-center">
            {surveys.map((survey)=>(
                <div key={survey.id} className="w-sm bg-white flex flex-col justify-center h-70 lg:w-2xl rounded-2xl shadow-sm border-4 border-white gap-3">
