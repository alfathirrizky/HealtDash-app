function SurveiCard({ question, onChange, question_id }) {
    // Defaulting to 1-5 scale since type is no longer in schema
    return (
        <div className="p-6 sm:p-8 mb-4 rounded-2xl border border-slate-100 bg-white shadow-sm hover:shadow-md hover:border-blue-200 transition-all duration-300">
            <div className="flex flex-col w-full">
                <h3 className="text-gray-800 font-semibold mb-5 text-lg md:text-xl leading-relaxed">
                    {question}
                </h3>
